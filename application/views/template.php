  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?=base_url('index.php/sepatu/dashboard')?>" class="logo"><b>myshoes</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile.html"><img src="<?=base_url()?>assets/img/us.png" class="img-circle" width="60"></a></p>
              	  <h5 class="centered"><?=$this->session->userdata('nama_user')?></h5>

                  <li class="mt">
                      <a class="active" href="<?=base_url('index.php/sepatu/')?>">
                  ...
                  <li class="sub-menu">
                      <a href="<?=base_url('index.php/sepatu/toko')?>" >
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Shoe Library</span>
                      </a>
                      <ul class="sub">
                          <!-- <li><a  href="<?=base_url('index.php/sepatu')?>">Daftar sepatu</a></li> -->
