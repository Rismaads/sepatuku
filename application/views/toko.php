...
<div class="container-fluid" style="background-color:white">
		<?php foreach($tampil_sepatu as $tb):?>
                      	<div class="col-md-4 col-sm-4 mb" >
                      		<div class="white-panel pn" style="margin:20px;width:auto;height:350px;">
                      			<div class="white-header" style="color:black!important;background-color:salmon !important;font-weight:bold!important;">
						  			<h5><?=$tb->nama_sepatu?></h5>
                      			</div>
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class="fa fa-heart"></i>Stock Item =  <?=$tb->stok?> </p>
									</div>
